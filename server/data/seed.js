  ...
  await Experience.insertMany([
    {
      ...
      endDate: "Jul 2024",
      points: [
        "Developed and maintained responsive web applications using JavaScript, React.js, and Node.js, contributing to multiple client-facing website projects.",
        "Built and integrated RESTful APIs with backend services, enabling dynamic data-driven features and improving application functionality.",
        "Collaborated with cross-functional teams to debug issues, optimize performance, and deliver scalable web solutions.",
      ],
      order: 0,
    },
    {
      ...
      endDate: "Apr 2023",
      points: [
        "Assisted in developing responsive web interfaces using HTML, CSS, and JavaScript, improving usability and design consistency.",
        "Supported development and testing of web applications while learning Git-based collaborative workflows.",
        "Worked with senior developers to debug issues and implement front-end enhancements.",
      ],
      order: 1,
    },
  ]);
