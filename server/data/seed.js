...
const seedData = async () => {
  ...
  await Project.insertMany([
    ...
    {
      title: "Color Couture — 3D Luxury Watch Store",
      subtitle: "Full-Stack MERN Web App with Three.js",
      stack: ["React", "Vite", "Three.js", "GSAP", "Express", "MongoDB"],
      description: [
        "Built an immersive e-commerce site for a New York Diamond District watch and fine-jewelry retailer, converting a static prototype into a full-stack MERN application.",
        "Implemented real-time 3D product visualization with Three.js and particle-driven motion graphics with GSAP, code-split to keep initial load light.",
        "Developed REST APIs on Express and MongoDB for the catalog, rate-limited appointment booking, and newsletter signup, deployed as a unified client + API app on Vercel.",
      ],
      liveUrl: "https://color-couture.vercel.app",
      featured: true,
      order: 1,
    },
  ]);
